...
public class ItemController {
    ...
    public ResponseUtil saveCustomer(@ModelAttribute ItemDTO item){
    ...
    public ResponseUtil updateCustomer(@RequestBody ItemDTO item){
        itemService.updateItem(item);
        return new ResponseUtil(200,"Updated",null);
    }

    @GetMapping(path = "/{code}",produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseUtil searchCustomer(@PathVariable String code) {
